...
public class HamkaranController {
    ...
    @FXML
    private void openAddNewHamkarPane(ActionEvent event) throws IOException {
        Pane view = myLoader.getPage("add_new_hamkar_pane");

        myBorderPane.setCenter(view);
    }

    @FXML
    private void openHamkaranList(ActionEvent event) throws IOException {
        Pane view = myLoader.getPage("hamkaranListPane");
        myBorderPane.setCenter(view);
    }
