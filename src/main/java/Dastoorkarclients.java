...
public class Dastoorkarclients {
    private Scene scene;
    private Stage stage;
    private Parent root;
    ...
    @FXML
    private void openAddDastoorClient(ActionEvent event) throws IOException {

        Pane view = myLoader.getPage("add_new_dastoor_client");

        myBorderPane.setCenter(view);
    }
    @FXML
    private void openDastoorClientList(ActionEvent event) throws IOException {
        Pane view = myLoader.getPage("list_dastoor_client");
        myBorderPane.setCenter(view);
    }
